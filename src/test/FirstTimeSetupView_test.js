...
/* Jasmine.js test suite for FirstTimeSetupView class in Meetup Event Planner app.
*
	...
	*/
	...
	// Test generic class features
		...
		it('inherits from ModalView', function() {
			...
			expect((new app.FirstTimeSetupView()) instanceof app.ModalView).toBe(true);
		});

		
		it('can be instantiated', function() {

			expect((new app.FirstTimeSetupView()).constructor).toBe(app.FirstTimeSetupView);
		});
	...
	describe('instance', function() {
		...
		beforeEach(function() {
			...
			testModal = new app.FirstTimeSetupView('modal-view', 'Delete');
		...
		// Test generic View features
			...
			it('responds to an update() call by rendering itself to the DOM', function() {
				...
				testModal.update(null, new app.FirstTimeSetupView());
