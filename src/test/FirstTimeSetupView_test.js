...
/* Jasmine.js test suite for FirstTimeSetupView class in Meetup Event Planner testApp.
*
...
describe('Class FirstTimeSetupView', function(){
	...
	*/
	...
	// Test generic class features
		...
		it('inherits from ModalView', function() {
			...
			expect((new testApp.FirstTimeSetupView()) instanceof testApp.ModalView).toBe(true);
		});

		
		it('can be instantiated', function() {

			expect((new testApp.FirstTimeSetupView()).constructor).toBe(testApp.FirstTimeSetupView);
		});
	...
	describe('instance', function() {
		...
		beforeEach(function() {
			...
			testModal = new testApp.FirstTimeSetupView('modal-view', 'Delete');
		...
		// Test generic View features
			...
			it('responds to an update() call by rendering itself to the DOM', function() {
				...
				testModal.update(null, new testApp.FirstTimeSetupView());
		...
		// Test presence of UI widgets
			...
			it('displays a local storage checkbox (switch)', function() {
				...
				var el = $(testElement).find('#setup-localstorage');
			...
			it('has the local storage checkbox (switch) set unchecked by default', function() {
			...
			it('displays a geolocation checkbox (switch)', function() {
				...
				var el = $(testElement).find('#setup-geolocation');
			...
			it('has the geolocation checkbox (switch) set unchecked by default', function() {
