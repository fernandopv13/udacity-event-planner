...
/* Jasmine.js unit test suite for ViewNavigateHandler class in meetup even planner application
*
...
describe('class ViewNavigateHandler', function(){
	
	var testHandler = new app.ViewNavigateHandler(new app.Controller());
	...
	it('can be instantiated', function() {
		...
		expect((new app.ViewNavigateHandler()).constructor).toBe(app.ViewNavigateHandler);
	});
