...
/* Jasmine.js test suite for ConfirmDeletionView class in Meetup Event Planner app.
*
	...
	*/
	...
	// Test generic class features
		...
		it('inherits from ModalView', function() {
			...
			expect((new app.ConfirmDeletionView()) instanceof app.ModalView).toBe(true);
		});

		
		it('can be instantiated', function() {

			expect((new app.ConfirmDeletionView()).constructor).toBe(app.ConfirmDeletionView);
		});
	...
	describe('instance', function() {
		...
		beforeEach(function() {
			...
			testModal = new app.ConfirmDeletionView('modal-view', 'Delete');
		...
		// Test generic View features
			...
			it('responds to an update() call by rendering itself to the DOM', function() {
				...
				testModal.update(null, new app.ConfirmDeletionView());
