...
(function (module) { // wrap initialization in anonymous function taking app/module context as parameter
	...
	/** @classdesc Creates, initializes and validates Materialize-styled HTML password input fields. Use as singleton to conserve memory resources.
	*
	* @constructor
	*
	* @extends InputWidget
		...
		*/
		...
		module.PasswordInputWidget.prototype.createProduct = function(obj_options) {
			...
			*/
			...
			var attributes =
			{
				type: 'password', // deliberately not hiding password, as per Luke W's advice for mobile, see https://www.youtube.com/watch?v=nmKMz3Fg76M @15:00
