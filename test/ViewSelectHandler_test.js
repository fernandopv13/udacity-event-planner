...
/* Jasmine.js unit test suite for ViewSelectHandler class in meetup even planner application
*
...
describe('class ViewSelectHandler', function(){
	
	var testHandler = new app.ViewSelectHandler(new app.Controller());
	...
	it('can be instantiated', function() {
		...
		expect((new app.ViewSelectHandler()).constructor).toBe(app.ViewSelectHandler);
	});
