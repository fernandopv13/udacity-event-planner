...
/* Jasmine.js unit test suite for ViewSignInHandler class in meetup even planner application
*
...
describe('class ViewSignInHandler', function(){
	
	var testHandler = new app.ViewSignInHandler(new app.Controller());
	...
	it('can be instantiated', function() {
		...
		expect((new app.ViewSignInHandler()).constructor).toBe(app.ViewSignInHandler);
	});
