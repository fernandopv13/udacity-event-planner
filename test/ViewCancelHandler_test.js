	...
	*/
	...
	beforeAll(function(done){
		...
		setTimeout(function() {
			...
			testApp.controller.onAccountSelected(testAccount); // show EventListView
			...
			testApp.controller.observers().forEach(function(observer) { // get instance registered w/controller
